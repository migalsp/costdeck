...
/** Standard wrapper for provider logos to ensure consistent sizing and alignment */
const LogoWrapper = ({ children, bgColor, className = "" }: { children: React.ReactNode, bgColor: string, className?: string }) => (
  <div className={`w-10 h-10 rounded-xl ${bgColor} flex items-center justify-center shrink-0 ${className}`}>
...
export const AWSLogo = ({ className = "" }: { className?: string }) => (
  <LogoWrapper bgColor="bg-[#FF9900]/10" className={className}>
    <svg viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      ...
      <path fill="#f90" d="M1.63 75.859c-.927.116-1.347 1.236-.368 2.121 16.508 14.902 38.359 23.872 62.613 23.872 17.305 0 37.43-5.43 51.281-15.66 2.273-1.688.297-4.254-2.02-3.204-15.534 6.57-32.421 9.77-47.788 9.77-22.778 0-44.8-6.273-62.653-16.633-.39-.231-.755-.304-1.064-.266z"/>
      <path fill="#f90" d="M118 73.348c-4.432.063-9.664 1.052-13.621 3.832-1.223.883-1.012 2.062.336 1.894 4.508-.547 14.44-1.726 16.21.547 1.77 2.23-1.976 11.62-3.663 15.79-.504 1.26.59 1.769 1.726.8 7.41-6.231 9.348-19.242 7.832-21.137-.757-.925-4.388-1.79-8.82-1.726z"/>
    </svg>
  </LogoWrapper>
);

export const AzureLogo = ({ className = "" }: { className?: string }) => (
  <LogoWrapper bgColor="bg-[#0078D4]/10" className={className}>
    <svg viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      <defs>
        <linearGradient id="azure-g1" x1="60.919" y1="9.602" x2="18.667" y2="134.423" gradientUnits="userSpaceOnUse">
          <stop stopColor="#114A8B"/><stop offset="1" stopColor="#0669BC"/>
        </linearGradient>
        <linearGradient id="azure-g2" x1="68.742" y1="5.961" x2="115.122" y2="129.525" gradientUnits="userSpaceOnUse">
          <stop stopColor="#3CCBF4"/><stop offset="1" stopColor="#2892DF"/>
        </linearGradient>
      </defs>
      <path d="M46.09.002h40.685L44.541 125.137a6.485 6.485 0 01-6.146 4.413H6.733a6.482 6.482 0 01-5.262-2.699 6.474 6.474 0 01-.876-5.848L39.944 4.414A6.488 6.488 0 0146.09 0z" fill="url(#azure-g1)" transform="translate(.587 4.468) scale(.91904)"/>
      <path d="M97.28 81.607H37.987a2.743 2.743 0 00-1.874 4.751l38.1 35.562a5.991 5.991 0 004.087 1.61h33.574z" fill="#0078d4"/>
      <path d="M98.055 4.408A6.476 6.476 0 0091.917.002H46.575a6.478 6.478 0 016.137 4.406l39.35 116.594a6.476 6.476 0 01-6.137 8.55h45.344a6.48 6.48 0 006.136-8.55z" fill="url(#azure-g2)" transform="translate(.587 4.468) scale(.91904)"/>
    </svg>
  </LogoWrapper>
);

export const GCPLogo = ({ className = "" }: { className?: string }) => (
  <LogoWrapper bgColor="bg-[#4285F4]/10" className={className}>
    <svg viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
...
export const WebexLogo = ({ className = "" }: { className?: string }) => (
  <LogoWrapper bgColor="bg-[#00B4E5]/10" className={className}>
    <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      <path d="M16 1C7.72 1 1 7.72 1 16s6.72 15 15 15 15-6.72 15-15S24.28 1 16 1zm0 24c-4.96 0-9-4.04-9-9s4.04-9 9-9 9 4.04 9 9-4.04 9-9 9z" fill="#00B4E5"/>
      <path d="M16 11c-2.76 0-5 2.24-5 5s2.24 5 5 5 5-2.24 5-5-2.24-5-5-5z" fill="#00B4E5"/>
    </svg>
  </LogoWrapper>
);
